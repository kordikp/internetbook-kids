...
export class RecombeeClient {
  ...
  async sendView(itemId, duration) {
    ...
    // Atribuce: recommId TOHO doporučení, ze kterého item přišel (per-item mapa;
    // globální _lastRecommId jen jako poslední záchrana) — viz Recombee guide.
  ...
  // Stránkování doporučení dle guide: další dávka téhož doporučení se řetězí
  // přes Recommend Next Items (recommId), ne novým dotazem od nuly.
