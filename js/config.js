// p-book — Jak funguje internet (školní edice)

export const CONFIG = {
  book: {
    title: 'Jak funguje internet?',
    author: 'Internet4Kids (MFF UK & PedF UK)',
    contentDir: 'content',
  ...
  voices: {
    explorer: { label: 'Průzkumník', icon: '\u{1F50D}', description: 'Jak to funguje? Ukaž mi to!' },
    creator: { label: 'Tvůrce', icon: '\u{1F3A8}', description: 'Chci něco vytvořit!' },
    thinker: { label: 'Myslitel', icon: '\u{1F9E0}', description: 'Proč to funguje zrovna takhle?' }
  },
