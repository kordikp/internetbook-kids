...
id: ch1-servery
type: spine
title: "Kde je to všechno uloženo?"
readingTime: 3
standalone: true
core: true
...
- Jedno video zabere v paměti průměrně **1 GB**.
- Dohromady je to asi **800 000 000 GB** dat.
- Tvůj mobil má přitom paměť typicky jen **32 až 128 GB**.

Všechna videa z YouTube by se do mobilu nevešla ani náhodou. Musí být uložena jinde – na **serverech**.
...
**Zkus to!** Nakresli si na papír dva velké překrývající se ovály (jako brýle). Levý nadepiš *pouze online*, pravý *pouze offline* a překrývající se část uprostřed *online i offline*. Do každé části napiš alespoň 2 činnosti, které na mobilu nebo počítači děláš. Nápověda: psaní zpráv kamarádům potřebuje internet, focení ne – a hraní her nebo poslech hudby může fungovat obojím způsobem.
