...
1. **Připrav si mřížku.** Vytiskni si pracovní list (na obrázku) nebo si nakresli mřížku **3 × 3** na papír. Do každého z devíti políček napiš jeden pojem z nabídky: server, síťový router, datové centrum, internet, BTS, cookies, datová stopa, IP adresa, paket, satelit, mobilní data, Wi-Fi, bezdrátové připojení, kabel, personalizace, Wi-Fi router, speedtest, poskytovatel internetu, hacker, hotspot, SIM karta, síť, podmořské kabely, požadavek na server, IP adresa příjemce, IP adresa odesílatele.
2. **Druhý hráč čte definice.** Nahlas a v náhodném pořadí čte **vysvětlení** pojmů (najde je v opakovacích kartách této kapitoly — pojmy jsou tučně). Pojem samotný neprozrazuje!
